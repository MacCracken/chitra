...
RGBA8 pixels — no GPU, no C shim, no external binaries. As of v0.7.0 it
...
make test          # 2820 assertions across tests/tcyr/
...
which returns `700` for 0.7.0 (`major*10000 + minor*100 + patch`).
